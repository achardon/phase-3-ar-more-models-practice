...
PlantCategory.create(plant_id: basil.id, category_id: 1)
PlantCategory.create(plant_id: basil.id, category_id: 2)
PlantCategory.create(plant_id: basil.id, category_id: 3)
...
PlantCategory.create(plant_id: cactus_1.id, category_id: 1)
PlantCategory.create(plant_id: cactus_1.id, category_id: 2)
PlantCategory.create(plant_id: cactus_1.id, category_id: 4)
